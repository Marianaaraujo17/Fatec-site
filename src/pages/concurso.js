...
=======
        <Row>
          ...
          <p id="subtitulo">
            Funcionários Técnico-Administrativos e Auxiliares de Docente
          </p>
          <p id="espaco">
            A contratação de funcionários técnico-administrativos e auxiliares
            de docente é feita somente através de concurso público.{" "}
          </p>
          <p id="subtitulo">Informações</p>
          <p>
          ...
          <a
            id="left"
            target="blank"
            href="https://urhsistemas.cps.sp.gov.br/dgsdad/default.aspx"
          >
...
>>>>>>> 6d0eb5d656e1591f2a4056cd35ff06be41829b32
      </Card>
    </Container>
    <Footer />
  </App>
